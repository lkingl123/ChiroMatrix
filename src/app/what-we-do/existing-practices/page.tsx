      ...
      <div className="bg-gray-100">
        ...
        <div className="max-w-5xl mx-auto py-16 px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            {/* <p className="mt-6 text-blue-600 font-medium">
              ...
              <a href="/services-programs" className="underline hover:text-blue-800">
          ...
          {/* Right Column */}
          <div className="bg-blue-600 text-white p-10 rounded-lg shadow-lg">
        ...
        <div className="bg-blue-600 text-white py-16 text-center">
          ...
          <a
            ...
            className="bg-white text-blue-600 py-3 px-8 rounded-lg text-lg font-semibold hover:bg-gray-300 transition duration-300"
          >
            Book a Consultation
          </a>
        </div>
