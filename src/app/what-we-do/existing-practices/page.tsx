    ...
    <div className="bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-lapis to-cerulean py-20 text-center text-white">
        <h1 className="text-5xl font-bold mb-6 tracking-tight">
          Supporting Existing Chiropractic Practices
        </h1>
        <p className="text-lg font-light max-w-2xl mx-auto">
          Take your chiropractic practice to the next level with our tailored strategies.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto py-16 px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="animate-slide-up">
          <h2 className="text-4xl font-bold text-gray-800 mb-6">
            We specialize in marketing for existing chiropractic practices.
          </h2>
          <p className="text-gray-700 text-lg leading-relaxed">
            Whether you've been in practice for years or are looking to grow, our team can help refine your marketing approach to attract more patients. We provide modern solutions tailored for chiropractors.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-cerulean to-sky text-white p-10 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
          <h2 className="text-2xl font-semibold mb-4">
            Join hundreds of successful chiropractic practices.
          </h2>
          <p>
            From branding to SEO, we've partnered with practices like yours to drive growth and patient satisfaction.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid gap-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <p className="text-gray-700 leading-relaxed">
                Our targeted advertising campaigns bring in qualified leads to grow your practice. Reach more patients and showcase your chiropractic services with effective marketing strategies.
              </p>
              <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <p className="text-gray-700 leading-relaxed">
                Improve your search engine rankings and online visibility. We help your practice get found by more patients with effective SEO strategies tailored for chiropractors.
              </p>
              <a
      ...
      <div className="bg-gradient-to-r from-lapis to-cerulean text-white py-16 text-center">
        ...
        <p className="text-lg leading-relaxed max-w-3xl mx-auto mb-8">
          Ready to grow your chiropractic practice? Contact us today to learn how our strategies can help take your practice to new heights.
        </p>
        <a
