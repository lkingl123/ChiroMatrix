    ...
    return (
      <div className="max-w-7xl mx-auto py-16 px-6">
        ...
        <p className="text-gray-700 mb-4">
          ...
          as the "Buyer"), and Plumbing Website Services, LLC (referred to as the
          "Service Provider"). By paying any invoice from Plumbing Website
        ...
        <p className="mt-2 text-gray-700">
          Branding services include logo creation, business cards, and other
          materials as specified in your Discovery Form. Each logo project
          includes up to six concepts and four revision rounds. Additional
          revisions are $50 per revision.
        </p>
        <p className="mt-2 text-gray-700">
          The Service Provider does not provide printing services or manage
          third-party printers.
        </p>
  
        <h3 className="text-xl font-semibold text-gray-800 mt-6">
          1.2 Website Design and Development
        </h3>
        <p className="mt-2 text-gray-700">
          We design responsive websites tailored to plumbing businesses. All
          websites are based on the branding and content you provide. Two
          revision rounds are included per page. Additional revisions or custom
          pages will incur extra fees.
        </p>
        <p className="mt-2 text-gray-700">
          Hosting and domain fees are the Buyer’s responsibility. Domain and
          website file transfers upon partnership termination will incur a $400
          fee.
        </p>
  
        <h3 className="text-xl font-semibold text-gray-800 mt-6">
          1.3 Website Updates and Maintenance
        </h3>
        <p className="mt-2 text-gray-700">
          A monthly fee of $70 covers basic updates and maintenance, including
          plugin updates and one hour of minor changes per month. Additional
          work, if required, will incur extra charges agreed upon before work
          begins.
        </p>
        ...
        <p className="mt-4 text-gray-700">
          ...
          paying an invoice from Plumbing Website Services, LLC, the Buyer
